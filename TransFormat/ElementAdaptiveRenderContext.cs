...
{
    public class ElementAdaptiveRenderContext
    {
        public ElementAdaptiveRenderContext(AdaptiveHostConfig hostConfig, AdaptiveElementRenderers<Element, ElementAdaptiveRenderContext> elementRenderers)
        {
            // clone it
        ...
        public AdaptiveElementRenderers<Element, ElementAdaptiveRenderContext> ElementRenderers { get; set; }

        public IList<AdaptiveWarning> Warnings { get; } = new List<AdaptiveWarning>();

        public Element Render(AdaptiveTypedElement element)
        {
